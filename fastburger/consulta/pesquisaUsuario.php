...
<body>
  <!-- SEÇÃO DE Consulta DE Usuario -->
      ...
      <div class="container">
        <div class="card">
        <section>
    <form action="pesquisaCompletaUsuario.php" method="POST">
          <h2>Dados</h2>
          <center>
            ...
            <table class="table">
              <thead>
                ...
                <?php
                  ...
                  $sql = ("SELECT usu_nome,  usu_cod, usu_senha FROM usuario WHERE usu_nome LIKE \"%$nome%\" group by 1");
                ...
                <tr>
                  <th>
                  <a href="pesquisaCompletaUsuario.php?id=<?php echo $codigo; ?>"><?php echo $codigo; ?></a><br><br>
                  </th>
                  <th>
                    <?php echo $nome; ?><br><br>
                  </th>
