...
<head>
  ...
  <title>Inclusão Cliente - FastBurger</title>
</head>

<body>
  <!-- SEÇÃO DE CADASTRO DE CLIENTE -->
  <section>
    <form action="../php_action/cadastroCliente.php" method="POST">
      <div class="container">
        <div class="card">
          ...
          <div class="card-content">
            <div class="linha">
              ...
              <div class="card-content-area">
                ...
                <input type="text" placeholder="Digite CPF ou CNPJ" name="cpfcnpj" class="cpf-mascara" />
              </div>
              <br />
              <div class="card-content-area">
